          ...
          >
            ...
            >
              <tr>
                ...
                <th scope="col" class="py-3 px-6">Meeting with</th>
                <th scope="col" class="py-3 px-6 overflow-y-auto">On Date</th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="py-4 px-6">{{ meeting.datetime }}</td>
                <!-- <td class="py-4 px-6">
                    <a
                      href="#"
...
export default defineComponent({
  ...
  setup() {
    ...
    const meetings = ref<Array<MeetingHistory>>([]);
    const isProcessing = ref(false);
    const ruleFormRef = ref<FormInstance>();
    const getMeeting = async () => {
      isLoading.value = true;
      meetings.value = await apiService.getMeeting();
      meetings.value = meetings.value[0]["meeting"];
